    ...
    return (
        <div className="container lg:w-3/4 mx-auto py-12 lg:px-0 md:px-5 px-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="bg-gray-100 border border-yellow-600 rounded-lg p-6 text-center">
                    <i className="fas fa-utensils text-4xl text-yellow-600 flex justify-center mb-4"></i>
                ...
                <div className="bg-gray-100 border border-yellow-600 rounded-lg p-6 text-center">
                    <i className="fas fa-glass-cheers text-4xl text-yellow-600 flex justify-center mb-4"></i>
                ...
                <div className="bg-gray-100 border border-yellow-600 rounded-lg p-6 text-center">
                    <i className="fas fa-calendar-check text-4xl text-yellow-600 flex justify-center mb-4"></i>
